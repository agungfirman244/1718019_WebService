const ApiKey = "f8b5fa7097ec48c19bc345467d0599bb";
...
const fetchHeader = {
    headers: {
        'X-Auth-Token': 'f8b5fa7097ec48c19bc345467d0599bb' 
    }
};
        ...
        .then(resJson => {
            ...
            resJson.teams.forEach(team => {
                ...
                <div id="modal${team.id}" class="modal">
                    ...
                    <a href="${team.website}" class="waves-effect waves-green btn-flat">Website ${team.name}</a>
